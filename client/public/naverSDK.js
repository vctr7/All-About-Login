    ...
    return (function (t) {
        ...
        function (t, n, e) {
            var r = e(162),
                ...
                h = function (t) {
                    return t === undefined || 'symbol' == typeof t
                        ? t
                        : String(t);
                },
                p = function (t) {
        ...
        function (t, n, e) {
            ...
            if (e(7)) {
                var r = e(34),
                    ...
                    Lt = function () {
                        for (
                            var t = 0, n = arguments.length, e = kt(this, n);
                            n > t;
                ...
                p(Vt, Ct),
                    ...
                    (t.exports = function (t, n, e, a) {
                        ...
                        var I = w[dt],
                            L =
                                !!I &&
                                ('values' == I.name || I.name == undefined),
                            F = Ct.values;
                        h(d, gt, !0),
                            h(w, xt, f),
                            h(w, _t, !0),
        ...
        function (t, n, e) {
            ...
            t.exports = function (t) {
                var n;
                return (
                    r(t) && ((n = t[o]) !== undefined ? !!n : 'RegExp' == i(t))
                );
            };
        },
        function (t, n, e) {
                    ...
                    ('__proto__' in {}
                        ? (function (t, n, r) {
                              try {
                                  (r = e(23)(
                                      Function.call,
                                      e(16).f(Object.prototype, '__proto__')
                                          .set,
                                      2
                                  )),
                                      r(t, []),
        ...
        function (t, n, e) {
            ...
            function p(t, n, e, r, i, o) {
                ...
                for (
                    var a = t[W]._b, f = c + t[z], s = r(+i), l = 0;
                    l < n;
                    l++
                )
                    a[f + l] = s[o ? l : n - l - 1];
        ...
        function (t, n, e) {
            ...
            t.exports = function (t) {
                return function (n) {
                    for (
                        var e, c = o(n), a = i(c), f = a.length, s = 0, l = [];
                        f > s;
                ...
                o = (function () {
                    ...
                    return (
                        (t.prototype.isError = function () {
                            return (
                                this.error !== undefined && null != this.error
                            );
                        }),
            ...
            i(
                ...
                'Array',
                {
                    from: function (t) {
                        ...
                        if (
                            (g &&
                                (v = r(v, d > 2 ? arguments[2] : undefined, 2)),
                ...
                return [
                    ...
                    function (t) {
                        ...
                        for (var l, h = [], p = 0; null !== (l = u(a, f)); ) {
                            ...
                            (h[p] = d),
                                '' === d &&
                                    (a.lastIndex = o(f, i(a.lastIndex), s)),
                                p++;
                        }
                        return 0 === p ? null : h;
                    },
                ...
                return [
                    ...
                    function (t, n) {
                        ...
                        for (var x = []; ; ) {
                            ...
                            if ((x.push(_), !y)) break;
                            '' === String(_[0]) &&
                                (l.lastIndex = c(h, o(l.lastIndex), m));
                        }
        ...
        function (t, n, e) {
            ...
            G ||
                ((j = function () {
                    ...
                    return (
                        o && H && Y(W, t, { configurable: !0, set: n }), q(t)
                    );
                }),
        ...
        function (t, n, e) {
            ...
            l(S.prototype, {
                ...
                l(S, {
                    ...
                    of: function () {
                        for (
                            var t = 0, n = arguments.length, e = new Array(n);
                            t < n;

                        )
                            e[t] = arguments[t++];
                        return new ('function' == typeof this ? this : S)(
                            function (t) {
                                var n = !1;
                                return (
                                    u(function () {
        ...
        function (t, n, e) {
            ...
            o.exp({
                getMetadataKeys: function (t) {
                    return s(
                        u(t),
                        arguments.length < 2 ? undefined : f(arguments[1])
                    );
                },
            });
        },
            ...
            r.exp({
                getMetadata: function (t, n) {
                    return f(
                        t,
                        i(n),
                        arguments.length < 3 ? undefined : a(arguments[2])
                    );
                },
            });
        },
        function (t, n, e) {
            ...
            r.exp({
                getOwnMetadataKeys: function (t) {
                    return o(
                        i(t),
                        arguments.length < 2 ? undefined : u(arguments[1])
                    );
                },
            });
        },
            ...
            r.exp({
                getOwnMetadata: function (t, n) {
                    return o(
                        t,
                        i(n),
                        arguments.length < 3 ? undefined : u(arguments[2])
                    );
                },
            });
        },
            ...
            r.exp({
                hasMetadata: function (t, n) {
                    return a(
                        t,
                        i(n),
                        arguments.length < 3 ? undefined : c(arguments[2])
                    );
                },
            });
        },
        ...
        function (t, n, e) {
            for (
                ...
                if (
                    _ &&
                    (_[s] || c(_, s, h), _[l] || c(_, l, y), (a[y] = h), m)
                )
                ...
                h = (function () {
                    ...
                    return (
                        (t.prototype.getAccessTokenFromLocal = function () {
                            var t = (0, u.getLocalStorageValue)(
                                this.accessTokenName
                            );
                            if (
                                ((null != t && t !== undefined) ||
                    ...
                    return (
                        (t.prototype.makeDefaultOptions = function () {
                            (this.options && '' !== this.options) ||
                                (this.options =
                                    'titlebar=1, resizable=1, scrollbars=yes'),
